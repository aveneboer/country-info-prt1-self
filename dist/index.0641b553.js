...
async function fetchCountries() {
    try {
        const response = await (0, _axiosDefault.default).get("https://restcountries.com/v3.1/all?fields=name,flags,continents,population");
        ...
        else if (e.response === 500) errorMessage.innerText = "Internal server error | 500";
    }
}
fetchCountries();
...
var Buffer = require("4301e1582c153c12").Buffer;
"use strict";
/**
...
},{"4301e1582c153c12":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("f2deb809cc7aa599");
var ieee754 = require("f0b3c67bc3cac8bd");
...
},{"f2deb809cc7aa599":"eIiSV","f0b3c67bc3cac8bd":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lKzq4","bNKaB"], "bNKaB", "parcelRequire2d28")
